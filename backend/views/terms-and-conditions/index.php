...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-title-container">
        <span class="form-header"><h4><i class="fa fa-paint-brush"></i> Set Terms and Conditions</h4></span>
    </div>
    <hr/>
            ...
            <?php foreach( $getTermsConditions as $row){ ?>
                <tr class="even_odd pointer">
                    ...
                    <td class="last tblalign_center">
                        ...
                        <a href="?r=terms-and-conditions/update&id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Edit Record" ><li class="fa fa-pencil-square"></li> </a> | 
