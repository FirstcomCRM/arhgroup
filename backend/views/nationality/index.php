...
/* @var $searchModel common\models\SearchNationality */
...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-title-container">
        <span class="form-header"><h4><i class="fa fa-paint-brush"></i> Set Nationality</h4></span>
    </div>
    <hr/>
...
<br/>
    ...
    <p>
        <a href="?r=nationality/create" id="option-list-link" class="btn btn-app">
            <i class="fa fa-plus-circle"></i> <b> New Nationality </b>
        </a>

        <a href="?r=nationality/export-excel" id="option-list-link" onclick="return excelPrintConfirmation()" class="btn btn-app">
            <i class="fa fa-file-excel-o"></i> <b> Print to Excel </b>
        </a>

        <a href="?r=nationality/export-pdf" id="option-list-link" onclick="return pdfPrintConfirmation()" class="btn btn-app">
 ...
 <br/>
    ...
    <thead>
        <tr style="font-size: 11px;" class="headings">
            ...
            <th class="tblalign_center" > NATIONALITY NAME </th>
    ...
    <tbody>
        <?php if(count($getNationality) > 0 ): ?>
            <?php foreach( $getNationality as $row){ ?>
