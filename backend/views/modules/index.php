...
<div>
    <?php if(Yii::$app->session->hasFlash('success')): ?>
        <div class="alert alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">×</a>
            <h5 class="alert-heading">
                <i class="fa fa-info-circle"></i> <?= Yii::$app->session->getFlash('success'); ?>
            </h5>
        </div>
    <?php endif; ?>
</div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="form-title-container">
        <span class="form-header"><h4><i class="fa fa-user-circle-o"></i> Module Maintenance</h4></span>
    </div>
    <hr/>
 ...
 <br/>
    ...
    <thead>
        <tr class="headings">
            ...
            <th class="tblalign_center" > SYSTEM MODULES </th>
