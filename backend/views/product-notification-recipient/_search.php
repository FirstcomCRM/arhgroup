...
/* @var $model common\models\SearchProductNotificationRecipient */
...
<div class="row">
    ...
    <div class="col-md-4">
        <?= $form->field($model, 'email')->textInput(['class' => 'form_input form-control', 'placeholder' => 'Enter Email here.'])->label(false) ?>
    </div>
