...
<br/>
    ...
    <!-- /.row -->
        ...
        <div id="paymentMethod" class="row remarksamountdueWrapper" style="padding-bottom: 10px;">
            <div class="col-xs-6" >
            <br>
            ...
            <br>
                ...
                <?php /*if ($customerInfo['points'] >= 400) { ?>
                    ...
                    <label><b>Claim redeempoints <i class="fa fa-product-hunt"></i>Points </b></label><input id="redeem-points-checkbox-view" style="margin-left:5px;" type="checkbox" name="redeempoints-input"><br>
                    <input id="redeempoints-before-payment" class="form_pm form-control" type="text" name="before-payment-redeempoints" placeholder="<?= 'Remaining points '.$customerInfo['points']; ?>">
                <?php  } */?>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <?php if( $customerInfo['status'] == 0 ): ?>
                    <a href="?r=invoice/delete-column&id=<?= $customerInfo['id'] ?>" onclick="return deleteConfirmation()"><button class="form-btn btn btn-danger btn-lg pull-left"><i class="fa fa-trash"></i> Delete Invoice</button></a>

                    <a href="?r=invoice/update&id=<?= $customerInfo['id'] ?>"><button class="form-btn btn btn-warning btn-lg pull-left"><i class="fa fa-edit"></i> Edit Invoice</button></a>
                <?php endif; ?>
                ...
                <a class="print-invoice-nopay" href="?r=invoice/print-invoice&id=<?= $customerInfo['id'] ?>&invoice_no=<?= $customerInfo['invoice_no'] ?>"><button class="form-btn btn btn-success btn-lg pull-right" ><i class="fa fa-print"></i> Print Invoice </button></a>
            </div>
        </div>
        <br/><br/>  
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody style="text-align: center;">
                                        <tr>
                                            ...
                                            <td class="paymentSubLabel" >
                                                <lable>$<?php echo number_format($paymentRow['paymentNet'],2); ?></lable>
                                            </td>
                                            <td class="paymentSubLabel" >
