...
if($model->invoice_no==NULL)
{
    ...
    $model->invoice_no = $invoiceCodeValue;
}
?>
...
<?php 
if($model->id=='')
    $form = ActiveForm::begin(['id' => 'create_invoice_form']); 
else
    $form = ActiveForm::begin(['id' => 'edit_invoice_form']); 
        ...
        <div class="col-lg-6" style="margin-top:20px">
            <div class="col-md-12">
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-4"><label class="customer-label"><i class="fa fa-barcode"></i>&nbsp;Invoice Number</label></div>
                        <div class="col-lg-7">
                            <?= $form->field($model, 'invoice_no')->textInput(['class' => 'form_input form-control', 'id' => 'invoice_no' ])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-7 required-field-block">
                            <select id="branch_id" name="Invoice[branch_id]" class="form-control select3_single select-branch">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-7 required-field-block">
                            <?= $form->field($model, 'customer_id')->dropDownList(array('0' => '- SELECT Car Plate HERE -') + $customer, ['class'=>'form-control form_input select3_single getInvCustomerInfo','id' => 'getInvCustomerInfo' , 'data-placeholder' => '- SELECT CUSTOMER HERE -'])->label(false); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <textarea name="Invoice[remarks]" style="font-size: 11.5px;" placeholder="Write your remarks here." id="message"  class="form-control"><?=$model->remarks!='' ? $model->remarks:''?></textarea> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <div class="col-md-12">
            ...
            <!-- <h4><i class="fa fa-info-circle"></i>&nbsp;Customer Information</h4> -->
                <div id="customer-invoice-information">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="col-md-12 col-xs-12 quotationHeader">
                            <div class="col-md-3 col-xs-3 table-th"><i class="fa fa-money"></i>&nbsp;Redeem Points</div>
                            <div class="col-md-7 col-xs-7 table-th"><i class="fa fa-commenting"></i>&nbsp;Redeem Description</div>
                        </div>
                    </div>
                    <div class="col-md-12 col-xs-12" style="margin-top:20px">
                        <div class="col-md-3 col-xs-3">
                            <input class="form-control input-sm" id="points_redeem" name="points_redeem" placeholder="No Points Available" data-point="0" value="<?=$redeem_point?>">
                        </div>
                        <div class="col-md-7 col-xs-7">
                            <textarea id="redeem_description" rows="1" style="font-size:11px;" name="redeem_description" class=" form-control" placeholder="Points Redeemed" >Discount from Redeemed Points</textarea>
                        </div>
                        <br/><br/><br/>
                    </div>
        ...
        <div class="row">
            <div class="col-md-offset-8 col-md-2 col-xs-1 text-right" style="padding-top:10px">Discount from Redeemed Points</div>
            <div class="col-md-2 col-xs-2">
                <input class="form-control" id="point_to_price" name="redeem_price" value="<?=$redeem_price?>" readonly>
            </div>
            <div class="clearfix">&nbsp;</div>
        </div>
...
<hr>
    <div style="text-align: right;">        
        <button type="submit" id="submitQuotation" class="form-btn btn btn-dark btn-lg" onclick="return confirm('Are you sure, you want to submit?')"><li class="fa fa-save"></li> <?=$model->id=='' ? 'Submit':'Edit'?> Invoice</button>
    </div>
<br>
</div>
<?php ActiveForm::end(); ?>
