...
class ExpensesController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        foreach ( $userRoleArray as $uRId => $uRName ){ 
            $permission = UserPermission::find()->where(['controller' => 'Expenses'])->andWhere(['role_id' => $uRId ])->andWhere(['status' => 1 ])->all();
    ...
    public function actionIndex()
    {
        ...
        if( !empty(Yii::$app->request->get('SearchExpenses')['name'])) {
                $getExpenses = $searchModel->SearchExpensesName(Yii::$app->request->get('SearchExpenses')['name']);

        }else {
                $getExpenses = Expenses::find()->where(['status' => 1])->all();
    ...
    {
        $result = Expenses::find()->where('id > 1')->andWhere(['status' => 1])->all();
        ...
        $filename = "ExpensesList-".date("m-d-Y").".xls";
    ...
    public function actionExportPdf() 
    {
        ...
        $dompdf->stream('ExpensesList-' . date('m-d-Y'));
    }
