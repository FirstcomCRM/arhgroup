...
class PaymentTypeController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        foreach ( $userRoleArray as $uRId => $uRName ){ 
            $permission = UserPermission::find()->where(['controller' => 'PaymentType'])->andWhere(['role_id' => $uRId ])->andWhere(['status' => 1 ])->all();
    ...
    public function actionIndex()
    {
        ...
        if( !empty(Yii::$app->request->get('SearchPaymentType')['name'])) {
    ...
    public function actionExportExcel() 
    {
        ...
        $objPHPExcel->setActiveSheetIndex($sheet);
            ...
            $objPHPExcel->getActiveSheet()->setTitle('xxx')                     
             ->setCellValue('A1', '#')
             ->setCellValue('B1', 'Payment-Type Name')
             ->setCellValue('C1', 'Payment-Type Description')
        ...
        $filename = "PaymentTypeList-".date("m-d-Y").".xls";
