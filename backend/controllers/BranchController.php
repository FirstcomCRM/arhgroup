...
class BranchController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        foreach ( $userRoleArray as $uRId => $uRName ){ 
            $permission = UserPermission::find()->where(['controller' => 'Branch'])->andWhere(['role_id' => $uRId ])->andWhere(['status' => 1 ])->all();
    ...
    public function actionIndex()
    {
        ...
        if( !empty(Yii::$app->request->get('SearchBranch')['name'])) {
            ...
            $getBranch = Branch::find()->where(['status' => 1])->all();
    ...
    public function actionNew()
    {
        ...
        if ( Yii::$app->request->post() ) {   
            ...
            $model->branch_type  = Yii::$app->request->post('branchType');
            $model->fax = Yii::$app->request->post('fax');
            $model->email = Yii::$app->request->post('email');
            $model->uen_no = Yii::$app->request->post('uen_no');
            $model->gst_no = Yii::$app->request->post('gst_no');
        ...
        $objPHPExcel->setActiveSheetIndex($sheet);
         ...
         $n = 0;
                ...
                foreach ($result as $result_row) {  
                    ...
                    $objPHPExcel->getActiveSheet()->setCellValue('C'.$row,$result_row['address']);
                    $objPHPExcel->getActiveSheet()->setCellValue('D'.$row,$result_row['contact_no']);
