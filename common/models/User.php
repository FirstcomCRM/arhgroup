...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['fullname', 'username', 'email', 'role_id','branch_id', 'password'], 'required', 'message' => 'Fill-up required fields.'],
            ...
            [['role_id', 'branch_id'], 'compare', 'compareValue' => 0, 'operator' => '>', 'type' => 'number', 'message' => 'Invalid option selected'],
    ...
    public static function dataUser($id=null) {
        return ArrayHelper::map(User::find()->where(['status' => 1])->all(), 'id', 'username');
    }
